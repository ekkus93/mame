...
describe("MAME startup and metadata empty-state parity tripwires", () => {
  ...
  it("distinguishes not-configured, import-needed, importing, failed, loaded, and no-match states", () => {
    for (const phrase of [
  ...
  it("keeps no-ROMs and unknown-availability states visible without a generic blank page", () => {
